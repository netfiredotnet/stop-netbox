...
// IpamAggregatesList200Response struct for IpamAggregatesList200Response
type IpamAggregatesList200Response struct {
...
func NewIpamAggregatesList200Response(count int32, results []Aggregate) *IpamAggregatesList200Response {
	this := IpamAggregatesList200Response{}
	this.Count = count
...
func (o *IpamAggregatesList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *IpamAggregatesList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o IpamAggregatesList200Response) MarshalJSON() ([]byte, error) {
...
type NullableIpamAggregatesList200Response struct {
	value *IpamAggregatesList200Response
	isSet bool
}

func (v NullableIpamAggregatesList200Response) Get() *IpamAggregatesList200Response {
	return v.value
}

func (v *NullableIpamAggregatesList200Response) Set(val *IpamAggregatesList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamAggregatesList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamAggregatesList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamAggregatesList200Response(val *IpamAggregatesList200Response) *NullableIpamAggregatesList200Response {
	return &NullableIpamAggregatesList200Response{value: val, isSet: true}
}

func (v NullableIpamAggregatesList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamAggregatesList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
