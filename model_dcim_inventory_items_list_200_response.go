...
// DcimInventoryItemsList200Response struct for DcimInventoryItemsList200Response
type DcimInventoryItemsList200Response struct {
...
func NewDcimInventoryItemsList200Response(count int32, results []InventoryItem) *DcimInventoryItemsList200Response {
	this := DcimInventoryItemsList200Response{}
	this.Count = count
...
func (o *DcimInventoryItemsList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *DcimInventoryItemsList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o DcimInventoryItemsList200Response) MarshalJSON() ([]byte, error) {
...
type NullableDcimInventoryItemsList200Response struct {
	value *DcimInventoryItemsList200Response
	isSet bool
}

func (v NullableDcimInventoryItemsList200Response) Get() *DcimInventoryItemsList200Response {
	return v.value
}

func (v *NullableDcimInventoryItemsList200Response) Set(val *DcimInventoryItemsList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDcimInventoryItemsList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDcimInventoryItemsList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDcimInventoryItemsList200Response(val *DcimInventoryItemsList200Response) *NullableDcimInventoryItemsList200Response {
	return &NullableDcimInventoryItemsList200Response{value: val, isSet: true}
}

func (v NullableDcimInventoryItemsList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDcimInventoryItemsList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
