...
// VirtualizationClusterGroupsList200Response struct for VirtualizationClusterGroupsList200Response
type VirtualizationClusterGroupsList200Response struct {
...
func NewVirtualizationClusterGroupsList200Response(count int32, results []ClusterGroup) *VirtualizationClusterGroupsList200Response {
	this := VirtualizationClusterGroupsList200Response{}
	this.Count = count
...
func (o *VirtualizationClusterGroupsList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *VirtualizationClusterGroupsList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o VirtualizationClusterGroupsList200Response) MarshalJSON() ([]byte, error) {
...
type NullableVirtualizationClusterGroupsList200Response struct {
	value *VirtualizationClusterGroupsList200Response
	isSet bool
}

func (v NullableVirtualizationClusterGroupsList200Response) Get() *VirtualizationClusterGroupsList200Response {
	return v.value
}

func (v *NullableVirtualizationClusterGroupsList200Response) Set(val *VirtualizationClusterGroupsList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationClusterGroupsList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationClusterGroupsList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationClusterGroupsList200Response(val *VirtualizationClusterGroupsList200Response) *NullableVirtualizationClusterGroupsList200Response {
	return &NullableVirtualizationClusterGroupsList200Response{value: val, isSet: true}
}

func (v NullableVirtualizationClusterGroupsList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationClusterGroupsList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
