...
// DcimPlatformsList200Response struct for DcimPlatformsList200Response
type DcimPlatformsList200Response struct {
...
func NewDcimPlatformsList200Response(count int32, results []Platform) *DcimPlatformsList200Response {
	this := DcimPlatformsList200Response{}
	this.Count = count
...
func (o *DcimPlatformsList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *DcimPlatformsList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o DcimPlatformsList200Response) MarshalJSON() ([]byte, error) {
...
type NullableDcimPlatformsList200Response struct {
	value *DcimPlatformsList200Response
	isSet bool
}

func (v NullableDcimPlatformsList200Response) Get() *DcimPlatformsList200Response {
	return v.value
}

func (v *NullableDcimPlatformsList200Response) Set(val *DcimPlatformsList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDcimPlatformsList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDcimPlatformsList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDcimPlatformsList200Response(val *DcimPlatformsList200Response) *NullableDcimPlatformsList200Response {
	return &NullableDcimPlatformsList200Response{value: val, isSet: true}
}

func (v NullableDcimPlatformsList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDcimPlatformsList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
