...
// SecretsSecretRolesList200Response struct for SecretsSecretRolesList200Response
type SecretsSecretRolesList200Response struct {
...
func NewSecretsSecretRolesList200Response(count int32, results []SecretRole) *SecretsSecretRolesList200Response {
	this := SecretsSecretRolesList200Response{}
	this.Count = count
...
func (o *SecretsSecretRolesList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *SecretsSecretRolesList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o SecretsSecretRolesList200Response) MarshalJSON() ([]byte, error) {
...
type NullableSecretsSecretRolesList200Response struct {
	value *SecretsSecretRolesList200Response
	isSet bool
}

func (v NullableSecretsSecretRolesList200Response) Get() *SecretsSecretRolesList200Response {
	return v.value
}

func (v *NullableSecretsSecretRolesList200Response) Set(val *SecretsSecretRolesList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSecretsSecretRolesList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSecretsSecretRolesList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecretsSecretRolesList200Response(val *SecretsSecretRolesList200Response) *NullableSecretsSecretRolesList200Response {
	return &NullableSecretsSecretRolesList200Response{value: val, isSet: true}
}

func (v NullableSecretsSecretRolesList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecretsSecretRolesList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
