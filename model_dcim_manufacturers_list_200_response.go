...
// DcimManufacturersList200Response struct for DcimManufacturersList200Response
type DcimManufacturersList200Response struct {
...
func NewDcimManufacturersList200Response(count int32, results []Manufacturer) *DcimManufacturersList200Response {
	this := DcimManufacturersList200Response{}
	this.Count = count
...
func (o *DcimManufacturersList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *DcimManufacturersList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o DcimManufacturersList200Response) MarshalJSON() ([]byte, error) {
...
type NullableDcimManufacturersList200Response struct {
	value *DcimManufacturersList200Response
	isSet bool
}

func (v NullableDcimManufacturersList200Response) Get() *DcimManufacturersList200Response {
	return v.value
}

func (v *NullableDcimManufacturersList200Response) Set(val *DcimManufacturersList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDcimManufacturersList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDcimManufacturersList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDcimManufacturersList200Response(val *DcimManufacturersList200Response) *NullableDcimManufacturersList200Response {
	return &NullableDcimManufacturersList200Response{value: val, isSet: true}
}

func (v NullableDcimManufacturersList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDcimManufacturersList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
