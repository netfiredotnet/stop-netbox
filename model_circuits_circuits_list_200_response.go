...
// CircuitsCircuitsList200Response struct for CircuitsCircuitsList200Response
type CircuitsCircuitsList200Response struct {
...
func NewCircuitsCircuitsList200Response(count int32, results []Circuit) *CircuitsCircuitsList200Response {
	this := CircuitsCircuitsList200Response{}
	this.Count = count
...
func (o *CircuitsCircuitsList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *CircuitsCircuitsList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o CircuitsCircuitsList200Response) MarshalJSON() ([]byte, error) {
...
type NullableCircuitsCircuitsList200Response struct {
	value *CircuitsCircuitsList200Response
	isSet bool
}

func (v NullableCircuitsCircuitsList200Response) Get() *CircuitsCircuitsList200Response {
	return v.value
}

func (v *NullableCircuitsCircuitsList200Response) Set(val *CircuitsCircuitsList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCircuitsCircuitsList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCircuitsCircuitsList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCircuitsCircuitsList200Response(val *CircuitsCircuitsList200Response) *NullableCircuitsCircuitsList200Response {
	return &NullableCircuitsCircuitsList200Response{value: val, isSet: true}
}

func (v NullableCircuitsCircuitsList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCircuitsCircuitsList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
