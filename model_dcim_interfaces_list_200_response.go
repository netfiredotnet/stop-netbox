...
// DcimInterfacesList200Response struct for DcimInterfacesList200Response
type DcimInterfacesList200Response struct {
...
func NewDcimInterfacesList200Response(count int32, results []Interface) *DcimInterfacesList200Response {
	this := DcimInterfacesList200Response{}
	this.Count = count
...
func (o *DcimInterfacesList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *DcimInterfacesList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o DcimInterfacesList200Response) MarshalJSON() ([]byte, error) {
...
type NullableDcimInterfacesList200Response struct {
	value *DcimInterfacesList200Response
	isSet bool
}

func (v NullableDcimInterfacesList200Response) Get() *DcimInterfacesList200Response {
	return v.value
}

func (v *NullableDcimInterfacesList200Response) Set(val *DcimInterfacesList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDcimInterfacesList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDcimInterfacesList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDcimInterfacesList200Response(val *DcimInterfacesList200Response) *NullableDcimInterfacesList200Response {
	return &NullableDcimInterfacesList200Response{value: val, isSet: true}
}

func (v NullableDcimInterfacesList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDcimInterfacesList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
