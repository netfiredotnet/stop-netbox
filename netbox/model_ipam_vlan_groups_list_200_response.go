...
// IpamVlanGroupsList200Response struct for IpamVlanGroupsList200Response
type IpamVlanGroupsList200Response struct {
...
func NewIpamVlanGroupsList200Response(count int32, results []VLANGroup) *IpamVlanGroupsList200Response {
	this := IpamVlanGroupsList200Response{}
	this.Count = count
...
func (o *IpamVlanGroupsList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *IpamVlanGroupsList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o IpamVlanGroupsList200Response) MarshalJSON() ([]byte, error) {
...
type NullableIpamVlanGroupsList200Response struct {
	value *IpamVlanGroupsList200Response
	isSet bool
}

func (v NullableIpamVlanGroupsList200Response) Get() *IpamVlanGroupsList200Response {
	return v.value
}

func (v *NullableIpamVlanGroupsList200Response) Set(val *IpamVlanGroupsList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamVlanGroupsList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamVlanGroupsList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamVlanGroupsList200Response(val *IpamVlanGroupsList200Response) *NullableIpamVlanGroupsList200Response {
	return &NullableIpamVlanGroupsList200Response{value: val, isSet: true}
}

func (v NullableIpamVlanGroupsList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamVlanGroupsList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
