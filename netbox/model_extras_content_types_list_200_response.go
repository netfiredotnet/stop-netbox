...
// ExtrasContentTypesList200Response struct for ExtrasContentTypesList200Response
type ExtrasContentTypesList200Response struct {
...
func NewExtrasContentTypesList200Response(count int32, results []ContentType) *ExtrasContentTypesList200Response {
	this := ExtrasContentTypesList200Response{}
	this.Count = count
...
func (o *ExtrasContentTypesList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *ExtrasContentTypesList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o ExtrasContentTypesList200Response) MarshalJSON() ([]byte, error) {
...
type NullableExtrasContentTypesList200Response struct {
	value *ExtrasContentTypesList200Response
	isSet bool
}

func (v NullableExtrasContentTypesList200Response) Get() *ExtrasContentTypesList200Response {
	return v.value
}

func (v *NullableExtrasContentTypesList200Response) Set(val *ExtrasContentTypesList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableExtrasContentTypesList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableExtrasContentTypesList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtrasContentTypesList200Response(val *ExtrasContentTypesList200Response) *NullableExtrasContentTypesList200Response {
	return &NullableExtrasContentTypesList200Response{value: val, isSet: true}
}

func (v NullableExtrasContentTypesList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtrasContentTypesList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
