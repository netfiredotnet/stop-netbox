...
// DcimInterfaceTemplatesList200Response struct for DcimInterfaceTemplatesList200Response
type DcimInterfaceTemplatesList200Response struct {
...
func NewDcimInterfaceTemplatesList200Response(count int32, results []InterfaceTemplate) *DcimInterfaceTemplatesList200Response {
	this := DcimInterfaceTemplatesList200Response{}
	this.Count = count
...
func (o *DcimInterfaceTemplatesList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *DcimInterfaceTemplatesList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o DcimInterfaceTemplatesList200Response) MarshalJSON() ([]byte, error) {
...
type NullableDcimInterfaceTemplatesList200Response struct {
	value *DcimInterfaceTemplatesList200Response
	isSet bool
}

func (v NullableDcimInterfaceTemplatesList200Response) Get() *DcimInterfaceTemplatesList200Response {
	return v.value
}

func (v *NullableDcimInterfaceTemplatesList200Response) Set(val *DcimInterfaceTemplatesList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDcimInterfaceTemplatesList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDcimInterfaceTemplatesList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDcimInterfaceTemplatesList200Response(val *DcimInterfaceTemplatesList200Response) *NullableDcimInterfaceTemplatesList200Response {
	return &NullableDcimInterfaceTemplatesList200Response{value: val, isSet: true}
}

func (v NullableDcimInterfaceTemplatesList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDcimInterfaceTemplatesList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
