...
// IpamRirsList200Response struct for IpamRirsList200Response
type IpamRirsList200Response struct {
...
func (o *IpamRirsList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *IpamRirsList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o IpamRirsList200Response) MarshalJSON() ([]byte, error) {
...
type NullableIpamRirsList200Response struct {
	value *IpamRirsList200Response
	isSet bool
}

func (v NullableIpamRirsList200Response) Get() *IpamRirsList200Response {
	return v.value
}

func (v *NullableIpamRirsList200Response) Set(val *IpamRirsList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamRirsList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamRirsList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamRirsList200Response(val *IpamRirsList200Response) *NullableIpamRirsList200Response {
	return &NullableIpamRirsList200Response{value: val, isSet: true}
}

func (v NullableIpamRirsList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamRirsList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
