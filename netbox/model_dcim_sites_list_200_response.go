...
// DcimSitesList200Response struct for DcimSitesList200Response
type DcimSitesList200Response struct {
...
func (o *DcimSitesList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *DcimSitesList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o DcimSitesList200Response) MarshalJSON() ([]byte, error) {
...
type NullableDcimSitesList200Response struct {
	value *DcimSitesList200Response
	isSet bool
}

func (v NullableDcimSitesList200Response) Get() *DcimSitesList200Response {
	return v.value
}

func (v *NullableDcimSitesList200Response) Set(val *DcimSitesList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDcimSitesList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDcimSitesList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDcimSitesList200Response(val *DcimSitesList200Response) *NullableDcimSitesList200Response {
	return &NullableDcimSitesList200Response{value: val, isSet: true}
}

func (v NullableDcimSitesList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDcimSitesList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
