...
// VirtualizationVirtualMachinesList200Response struct for VirtualizationVirtualMachinesList200Response
type VirtualizationVirtualMachinesList200Response struct {
...
func NewVirtualizationVirtualMachinesList200Response(count int32, results []VirtualMachineWithConfigContext) *VirtualizationVirtualMachinesList200Response {
	this := VirtualizationVirtualMachinesList200Response{}
	this.Count = count
...
func (o *VirtualizationVirtualMachinesList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *VirtualizationVirtualMachinesList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o VirtualizationVirtualMachinesList200Response) MarshalJSON() ([]byte, error) {
...
type NullableVirtualizationVirtualMachinesList200Response struct {
	value *VirtualizationVirtualMachinesList200Response
	isSet bool
}

func (v NullableVirtualizationVirtualMachinesList200Response) Get() *VirtualizationVirtualMachinesList200Response {
	return v.value
}

func (v *NullableVirtualizationVirtualMachinesList200Response) Set(val *VirtualizationVirtualMachinesList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationVirtualMachinesList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationVirtualMachinesList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationVirtualMachinesList200Response(val *VirtualizationVirtualMachinesList200Response) *NullableVirtualizationVirtualMachinesList200Response {
	return &NullableVirtualizationVirtualMachinesList200Response{value: val, isSet: true}
}

func (v NullableVirtualizationVirtualMachinesList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationVirtualMachinesList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
