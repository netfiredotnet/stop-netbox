...
// ExtrasTagsList200Response struct for ExtrasTagsList200Response
type ExtrasTagsList200Response struct {
...
func NewExtrasTagsList200Response(count int32, results []Tag) *ExtrasTagsList200Response {
	this := ExtrasTagsList200Response{}
	this.Count = count
...
func (o *ExtrasTagsList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *ExtrasTagsList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o ExtrasTagsList200Response) MarshalJSON() ([]byte, error) {
...
type NullableExtrasTagsList200Response struct {
	value *ExtrasTagsList200Response
	isSet bool
}

func (v NullableExtrasTagsList200Response) Get() *ExtrasTagsList200Response {
	return v.value
}

func (v *NullableExtrasTagsList200Response) Set(val *ExtrasTagsList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableExtrasTagsList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableExtrasTagsList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtrasTagsList200Response(val *ExtrasTagsList200Response) *NullableExtrasTagsList200Response {
	return &NullableExtrasTagsList200Response{value: val, isSet: true}
}

func (v NullableExtrasTagsList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtrasTagsList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
