...
// DcimPowerPanelsList200Response struct for DcimPowerPanelsList200Response
type DcimPowerPanelsList200Response struct {
...
func NewDcimPowerPanelsList200Response(count int32, results []PowerPanel) *DcimPowerPanelsList200Response {
	this := DcimPowerPanelsList200Response{}
	this.Count = count
...
func (o *DcimPowerPanelsList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *DcimPowerPanelsList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o DcimPowerPanelsList200Response) MarshalJSON() ([]byte, error) {
...
type NullableDcimPowerPanelsList200Response struct {
	value *DcimPowerPanelsList200Response
	isSet bool
}

func (v NullableDcimPowerPanelsList200Response) Get() *DcimPowerPanelsList200Response {
	return v.value
}

func (v *NullableDcimPowerPanelsList200Response) Set(val *DcimPowerPanelsList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDcimPowerPanelsList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDcimPowerPanelsList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDcimPowerPanelsList200Response(val *DcimPowerPanelsList200Response) *NullableDcimPowerPanelsList200Response {
	return &NullableDcimPowerPanelsList200Response{value: val, isSet: true}
}

func (v NullableDcimPowerPanelsList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDcimPowerPanelsList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
