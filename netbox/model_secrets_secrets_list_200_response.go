...
// SecretsSecretsList200Response struct for SecretsSecretsList200Response
type SecretsSecretsList200Response struct {
...
func NewSecretsSecretsList200Response(count int32, results []Secret) *SecretsSecretsList200Response {
	this := SecretsSecretsList200Response{}
	this.Count = count
...
func (o *SecretsSecretsList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *SecretsSecretsList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o SecretsSecretsList200Response) MarshalJSON() ([]byte, error) {
...
type NullableSecretsSecretsList200Response struct {
	value *SecretsSecretsList200Response
	isSet bool
}

func (v NullableSecretsSecretsList200Response) Get() *SecretsSecretsList200Response {
	return v.value
}

func (v *NullableSecretsSecretsList200Response) Set(val *SecretsSecretsList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSecretsSecretsList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSecretsSecretsList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecretsSecretsList200Response(val *SecretsSecretsList200Response) *NullableSecretsSecretsList200Response {
	return &NullableSecretsSecretsList200Response{value: val, isSet: true}
}

func (v NullableSecretsSecretsList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecretsSecretsList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
