...
// UsersUsersList200Response struct for UsersUsersList200Response
type UsersUsersList200Response struct {
...
func NewUsersUsersList200Response(count int32, results []User) *UsersUsersList200Response {
	this := UsersUsersList200Response{}
	this.Count = count
...
func (o *UsersUsersList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *UsersUsersList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o UsersUsersList200Response) MarshalJSON() ([]byte, error) {
...
type NullableUsersUsersList200Response struct {
	value *UsersUsersList200Response
	isSet bool
}

func (v NullableUsersUsersList200Response) Get() *UsersUsersList200Response {
	return v.value
}

func (v *NullableUsersUsersList200Response) Set(val *UsersUsersList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUsersUsersList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUsersUsersList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUsersUsersList200Response(val *UsersUsersList200Response) *NullableUsersUsersList200Response {
	return &NullableUsersUsersList200Response{value: val, isSet: true}
}

func (v NullableUsersUsersList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUsersUsersList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
