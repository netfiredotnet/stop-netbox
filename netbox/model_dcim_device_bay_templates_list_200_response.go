...
// DcimDeviceBayTemplatesList200Response struct for DcimDeviceBayTemplatesList200Response
type DcimDeviceBayTemplatesList200Response struct {
...
func NewDcimDeviceBayTemplatesList200Response(count int32, results []DeviceBayTemplate) *DcimDeviceBayTemplatesList200Response {
	this := DcimDeviceBayTemplatesList200Response{}
	this.Count = count
...
func (o *DcimDeviceBayTemplatesList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *DcimDeviceBayTemplatesList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o DcimDeviceBayTemplatesList200Response) MarshalJSON() ([]byte, error) {
...
type NullableDcimDeviceBayTemplatesList200Response struct {
	value *DcimDeviceBayTemplatesList200Response
	isSet bool
}

func (v NullableDcimDeviceBayTemplatesList200Response) Get() *DcimDeviceBayTemplatesList200Response {
	return v.value
}

func (v *NullableDcimDeviceBayTemplatesList200Response) Set(val *DcimDeviceBayTemplatesList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDcimDeviceBayTemplatesList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDcimDeviceBayTemplatesList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDcimDeviceBayTemplatesList200Response(val *DcimDeviceBayTemplatesList200Response) *NullableDcimDeviceBayTemplatesList200Response {
	return &NullableDcimDeviceBayTemplatesList200Response{value: val, isSet: true}
}

func (v NullableDcimDeviceBayTemplatesList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDcimDeviceBayTemplatesList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
