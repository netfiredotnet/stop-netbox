...
// ExtrasJobResultsList200Response struct for ExtrasJobResultsList200Response
type ExtrasJobResultsList200Response struct {
...
func NewExtrasJobResultsList200Response(count int32, results []JobResult) *ExtrasJobResultsList200Response {
	this := ExtrasJobResultsList200Response{}
	this.Count = count
...
func (o *ExtrasJobResultsList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *ExtrasJobResultsList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o ExtrasJobResultsList200Response) MarshalJSON() ([]byte, error) {
...
type NullableExtrasJobResultsList200Response struct {
	value *ExtrasJobResultsList200Response
	isSet bool
}

func (v NullableExtrasJobResultsList200Response) Get() *ExtrasJobResultsList200Response {
	return v.value
}

func (v *NullableExtrasJobResultsList200Response) Set(val *ExtrasJobResultsList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableExtrasJobResultsList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableExtrasJobResultsList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtrasJobResultsList200Response(val *ExtrasJobResultsList200Response) *NullableExtrasJobResultsList200Response {
	return &NullableExtrasJobResultsList200Response{value: val, isSet: true}
}

func (v NullableExtrasJobResultsList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtrasJobResultsList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
