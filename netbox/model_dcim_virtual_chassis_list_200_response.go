...
// DcimVirtualChassisList200Response struct for DcimVirtualChassisList200Response
type DcimVirtualChassisList200Response struct {
...
func NewDcimVirtualChassisList200Response(count int32, results []VirtualChassis) *DcimVirtualChassisList200Response {
	this := DcimVirtualChassisList200Response{}
	this.Count = count
...
func (o *DcimVirtualChassisList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *DcimVirtualChassisList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o DcimVirtualChassisList200Response) MarshalJSON() ([]byte, error) {
...
type NullableDcimVirtualChassisList200Response struct {
	value *DcimVirtualChassisList200Response
	isSet bool
}

func (v NullableDcimVirtualChassisList200Response) Get() *DcimVirtualChassisList200Response {
	return v.value
}

func (v *NullableDcimVirtualChassisList200Response) Set(val *DcimVirtualChassisList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDcimVirtualChassisList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDcimVirtualChassisList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDcimVirtualChassisList200Response(val *DcimVirtualChassisList200Response) *NullableDcimVirtualChassisList200Response {
	return &NullableDcimVirtualChassisList200Response{value: val, isSet: true}
}

func (v NullableDcimVirtualChassisList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDcimVirtualChassisList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
