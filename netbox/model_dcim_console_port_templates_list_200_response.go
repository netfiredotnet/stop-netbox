...
// DcimConsolePortTemplatesList200Response struct for DcimConsolePortTemplatesList200Response
type DcimConsolePortTemplatesList200Response struct {
...
func NewDcimConsolePortTemplatesList200Response(count int32, results []ConsolePortTemplate) *DcimConsolePortTemplatesList200Response {
	this := DcimConsolePortTemplatesList200Response{}
	this.Count = count
...
func (o *DcimConsolePortTemplatesList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *DcimConsolePortTemplatesList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o DcimConsolePortTemplatesList200Response) MarshalJSON() ([]byte, error) {
...
type NullableDcimConsolePortTemplatesList200Response struct {
	value *DcimConsolePortTemplatesList200Response
	isSet bool
}

func (v NullableDcimConsolePortTemplatesList200Response) Get() *DcimConsolePortTemplatesList200Response {
	return v.value
}

func (v *NullableDcimConsolePortTemplatesList200Response) Set(val *DcimConsolePortTemplatesList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDcimConsolePortTemplatesList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDcimConsolePortTemplatesList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDcimConsolePortTemplatesList200Response(val *DcimConsolePortTemplatesList200Response) *NullableDcimConsolePortTemplatesList200Response {
	return &NullableDcimConsolePortTemplatesList200Response{value: val, isSet: true}
}

func (v NullableDcimConsolePortTemplatesList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDcimConsolePortTemplatesList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
