...
// VirtualizationClustersList200Response struct for VirtualizationClustersList200Response
type VirtualizationClustersList200Response struct {
...
func NewVirtualizationClustersList200Response(count int32, results []Cluster) *VirtualizationClustersList200Response {
	this := VirtualizationClustersList200Response{}
	this.Count = count
...
func (o *VirtualizationClustersList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *VirtualizationClustersList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o VirtualizationClustersList200Response) MarshalJSON() ([]byte, error) {
...
type NullableVirtualizationClustersList200Response struct {
	value *VirtualizationClustersList200Response
	isSet bool
}

func (v NullableVirtualizationClustersList200Response) Get() *VirtualizationClustersList200Response {
	return v.value
}

func (v *NullableVirtualizationClustersList200Response) Set(val *VirtualizationClustersList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationClustersList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationClustersList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationClustersList200Response(val *VirtualizationClustersList200Response) *NullableVirtualizationClustersList200Response {
	return &NullableVirtualizationClustersList200Response{value: val, isSet: true}
}

func (v NullableVirtualizationClustersList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationClustersList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
