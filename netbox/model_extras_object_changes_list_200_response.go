...
// ExtrasObjectChangesList200Response struct for ExtrasObjectChangesList200Response
type ExtrasObjectChangesList200Response struct {
...
func NewExtrasObjectChangesList200Response(count int32, results []ObjectChange) *ExtrasObjectChangesList200Response {
	this := ExtrasObjectChangesList200Response{}
	this.Count = count
...
func (o *ExtrasObjectChangesList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *ExtrasObjectChangesList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o ExtrasObjectChangesList200Response) MarshalJSON() ([]byte, error) {
...
type NullableExtrasObjectChangesList200Response struct {
	value *ExtrasObjectChangesList200Response
	isSet bool
}

func (v NullableExtrasObjectChangesList200Response) Get() *ExtrasObjectChangesList200Response {
	return v.value
}

func (v *NullableExtrasObjectChangesList200Response) Set(val *ExtrasObjectChangesList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableExtrasObjectChangesList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableExtrasObjectChangesList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtrasObjectChangesList200Response(val *ExtrasObjectChangesList200Response) *NullableExtrasObjectChangesList200Response {
	return &NullableExtrasObjectChangesList200Response{value: val, isSet: true}
}

func (v NullableExtrasObjectChangesList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtrasObjectChangesList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
