...
// DcimFrontPortTemplatesList200Response struct for DcimFrontPortTemplatesList200Response
type DcimFrontPortTemplatesList200Response struct {
...
func NewDcimFrontPortTemplatesList200Response(count int32, results []FrontPortTemplate) *DcimFrontPortTemplatesList200Response {
	this := DcimFrontPortTemplatesList200Response{}
	this.Count = count
...
func (o *DcimFrontPortTemplatesList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *DcimFrontPortTemplatesList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o DcimFrontPortTemplatesList200Response) MarshalJSON() ([]byte, error) {
...
type NullableDcimFrontPortTemplatesList200Response struct {
	value *DcimFrontPortTemplatesList200Response
	isSet bool
}

func (v NullableDcimFrontPortTemplatesList200Response) Get() *DcimFrontPortTemplatesList200Response {
	return v.value
}

func (v *NullableDcimFrontPortTemplatesList200Response) Set(val *DcimFrontPortTemplatesList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDcimFrontPortTemplatesList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDcimFrontPortTemplatesList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDcimFrontPortTemplatesList200Response(val *DcimFrontPortTemplatesList200Response) *NullableDcimFrontPortTemplatesList200Response {
	return &NullableDcimFrontPortTemplatesList200Response{value: val, isSet: true}
}

func (v NullableDcimFrontPortTemplatesList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDcimFrontPortTemplatesList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
