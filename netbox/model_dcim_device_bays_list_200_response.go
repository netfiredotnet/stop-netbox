...
// DcimDeviceBaysList200Response struct for DcimDeviceBaysList200Response
type DcimDeviceBaysList200Response struct {
...
func NewDcimDeviceBaysList200Response(count int32, results []DeviceBay) *DcimDeviceBaysList200Response {
	this := DcimDeviceBaysList200Response{}
	this.Count = count
...
func (o *DcimDeviceBaysList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *DcimDeviceBaysList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o DcimDeviceBaysList200Response) MarshalJSON() ([]byte, error) {
...
type NullableDcimDeviceBaysList200Response struct {
	value *DcimDeviceBaysList200Response
	isSet bool
}

func (v NullableDcimDeviceBaysList200Response) Get() *DcimDeviceBaysList200Response {
	return v.value
}

func (v *NullableDcimDeviceBaysList200Response) Set(val *DcimDeviceBaysList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDcimDeviceBaysList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDcimDeviceBaysList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDcimDeviceBaysList200Response(val *DcimDeviceBaysList200Response) *NullableDcimDeviceBaysList200Response {
	return &NullableDcimDeviceBaysList200Response{value: val, isSet: true}
}

func (v NullableDcimDeviceBaysList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDcimDeviceBaysList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
