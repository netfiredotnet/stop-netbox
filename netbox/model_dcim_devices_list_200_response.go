...
// DcimDevicesList200Response struct for DcimDevicesList200Response
type DcimDevicesList200Response struct {
...
func NewDcimDevicesList200Response(count int32, results []DeviceWithConfigContext) *DcimDevicesList200Response {
	this := DcimDevicesList200Response{}
	this.Count = count
...
func (o *DcimDevicesList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *DcimDevicesList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o DcimDevicesList200Response) MarshalJSON() ([]byte, error) {
...
type NullableDcimDevicesList200Response struct {
	value *DcimDevicesList200Response
	isSet bool
}

func (v NullableDcimDevicesList200Response) Get() *DcimDevicesList200Response {
	return v.value
}

func (v *NullableDcimDevicesList200Response) Set(val *DcimDevicesList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDcimDevicesList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDcimDevicesList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDcimDevicesList200Response(val *DcimDevicesList200Response) *NullableDcimDevicesList200Response {
	return &NullableDcimDevicesList200Response{value: val, isSet: true}
}

func (v NullableDcimDevicesList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDcimDevicesList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
