...
// DcimSiteGroupsList200Response struct for DcimSiteGroupsList200Response
type DcimSiteGroupsList200Response struct {
...
func NewDcimSiteGroupsList200Response(count int32, results []SiteGroup) *DcimSiteGroupsList200Response {
	this := DcimSiteGroupsList200Response{}
	this.Count = count
...
func (o *DcimSiteGroupsList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *DcimSiteGroupsList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o DcimSiteGroupsList200Response) MarshalJSON() ([]byte, error) {
...
type NullableDcimSiteGroupsList200Response struct {
	value *DcimSiteGroupsList200Response
	isSet bool
}

func (v NullableDcimSiteGroupsList200Response) Get() *DcimSiteGroupsList200Response {
	return v.value
}

func (v *NullableDcimSiteGroupsList200Response) Set(val *DcimSiteGroupsList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDcimSiteGroupsList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDcimSiteGroupsList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDcimSiteGroupsList200Response(val *DcimSiteGroupsList200Response) *NullableDcimSiteGroupsList200Response {
	return &NullableDcimSiteGroupsList200Response{value: val, isSet: true}
}

func (v NullableDcimSiteGroupsList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDcimSiteGroupsList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
