...
// WritableCircuit struct for WritableCircuit
...
// SetTerminationA gets a reference to the given int32 and assigns it to the TerminationA field.
...
// SetTerminationZ gets a reference to the given int32 and assigns it to the TerminationZ field.
