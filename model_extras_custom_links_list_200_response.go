...
// ExtrasCustomLinksList200Response struct for ExtrasCustomLinksList200Response
type ExtrasCustomLinksList200Response struct {
...
func NewExtrasCustomLinksList200Response(count int32, results []CustomLink) *ExtrasCustomLinksList200Response {
	this := ExtrasCustomLinksList200Response{}
	this.Count = count
...
func (o *ExtrasCustomLinksList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *ExtrasCustomLinksList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o ExtrasCustomLinksList200Response) MarshalJSON() ([]byte, error) {
...
type NullableExtrasCustomLinksList200Response struct {
	value *ExtrasCustomLinksList200Response
	isSet bool
}

func (v NullableExtrasCustomLinksList200Response) Get() *ExtrasCustomLinksList200Response {
	return v.value
}

func (v *NullableExtrasCustomLinksList200Response) Set(val *ExtrasCustomLinksList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableExtrasCustomLinksList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableExtrasCustomLinksList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtrasCustomLinksList200Response(val *ExtrasCustomLinksList200Response) *NullableExtrasCustomLinksList200Response {
	return &NullableExtrasCustomLinksList200Response{value: val, isSet: true}
}

func (v NullableExtrasCustomLinksList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtrasCustomLinksList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
