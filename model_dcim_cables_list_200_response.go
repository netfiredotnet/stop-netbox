...
// DcimCablesList200Response struct for DcimCablesList200Response
type DcimCablesList200Response struct {
...
func NewDcimCablesList200Response(count int32, results []Cable) *DcimCablesList200Response {
	this := DcimCablesList200Response{}
	this.Count = count
...
func (o *DcimCablesList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *DcimCablesList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o DcimCablesList200Response) MarshalJSON() ([]byte, error) {
...
type NullableDcimCablesList200Response struct {
	value *DcimCablesList200Response
	isSet bool
}

func (v NullableDcimCablesList200Response) Get() *DcimCablesList200Response {
	return v.value
}

func (v *NullableDcimCablesList200Response) Set(val *DcimCablesList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDcimCablesList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDcimCablesList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDcimCablesList200Response(val *DcimCablesList200Response) *NullableDcimCablesList200Response {
	return &NullableDcimCablesList200Response{value: val, isSet: true}
}

func (v NullableDcimCablesList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDcimCablesList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
