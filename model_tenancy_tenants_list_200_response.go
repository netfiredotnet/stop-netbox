...
// TenancyTenantsList200Response struct for TenancyTenantsList200Response
type TenancyTenantsList200Response struct {
...
func NewTenancyTenantsList200Response(count int32, results []Tenant) *TenancyTenantsList200Response {
	this := TenancyTenantsList200Response{}
	this.Count = count
...
func (o *TenancyTenantsList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *TenancyTenantsList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o TenancyTenantsList200Response) MarshalJSON() ([]byte, error) {
...
type NullableTenancyTenantsList200Response struct {
	value *TenancyTenantsList200Response
	isSet bool
}

func (v NullableTenancyTenantsList200Response) Get() *TenancyTenantsList200Response {
	return v.value
}

func (v *NullableTenancyTenantsList200Response) Set(val *TenancyTenantsList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableTenancyTenantsList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableTenancyTenantsList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenancyTenantsList200Response(val *TenancyTenantsList200Response) *NullableTenancyTenantsList200Response {
	return &NullableTenancyTenantsList200Response{value: val, isSet: true}
}

func (v NullableTenancyTenantsList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenancyTenantsList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
