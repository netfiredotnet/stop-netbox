...
// CircuitsProvidersList200Response struct for CircuitsProvidersList200Response
type CircuitsProvidersList200Response struct {
...
func NewCircuitsProvidersList200Response(count int32, results []Provider) *CircuitsProvidersList200Response {
	this := CircuitsProvidersList200Response{}
	this.Count = count
...
func (o *CircuitsProvidersList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *CircuitsProvidersList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o CircuitsProvidersList200Response) MarshalJSON() ([]byte, error) {
...
type NullableCircuitsProvidersList200Response struct {
	value *CircuitsProvidersList200Response
	isSet bool
}

func (v NullableCircuitsProvidersList200Response) Get() *CircuitsProvidersList200Response {
	return v.value
}

func (v *NullableCircuitsProvidersList200Response) Set(val *CircuitsProvidersList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCircuitsProvidersList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCircuitsProvidersList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCircuitsProvidersList200Response(val *CircuitsProvidersList200Response) *NullableCircuitsProvidersList200Response {
	return &NullableCircuitsProvidersList200Response{value: val, isSet: true}
}

func (v NullableCircuitsProvidersList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCircuitsProvidersList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
