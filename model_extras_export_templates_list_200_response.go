...
// ExtrasExportTemplatesList200Response struct for ExtrasExportTemplatesList200Response
type ExtrasExportTemplatesList200Response struct {
...
func NewExtrasExportTemplatesList200Response(count int32, results []ExportTemplate) *ExtrasExportTemplatesList200Response {
	this := ExtrasExportTemplatesList200Response{}
	this.Count = count
...
func (o *ExtrasExportTemplatesList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *ExtrasExportTemplatesList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o ExtrasExportTemplatesList200Response) MarshalJSON() ([]byte, error) {
...
type NullableExtrasExportTemplatesList200Response struct {
	value *ExtrasExportTemplatesList200Response
	isSet bool
}

func (v NullableExtrasExportTemplatesList200Response) Get() *ExtrasExportTemplatesList200Response {
	return v.value
}

func (v *NullableExtrasExportTemplatesList200Response) Set(val *ExtrasExportTemplatesList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableExtrasExportTemplatesList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableExtrasExportTemplatesList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtrasExportTemplatesList200Response(val *ExtrasExportTemplatesList200Response) *NullableExtrasExportTemplatesList200Response {
	return &NullableExtrasExportTemplatesList200Response{value: val, isSet: true}
}

func (v NullableExtrasExportTemplatesList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtrasExportTemplatesList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
