...
// DcimConsoleConnectionsList200Response struct for DcimConsoleConnectionsList200Response
type DcimConsoleConnectionsList200Response struct {
...
func NewDcimConsoleConnectionsList200Response(count int32, results []ConsolePort) *DcimConsoleConnectionsList200Response {
	this := DcimConsoleConnectionsList200Response{}
	this.Count = count
...
func (o *DcimConsoleConnectionsList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *DcimConsoleConnectionsList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o DcimConsoleConnectionsList200Response) MarshalJSON() ([]byte, error) {
...
type NullableDcimConsoleConnectionsList200Response struct {
	value *DcimConsoleConnectionsList200Response
	isSet bool
}

func (v NullableDcimConsoleConnectionsList200Response) Get() *DcimConsoleConnectionsList200Response {
	return v.value
}

func (v *NullableDcimConsoleConnectionsList200Response) Set(val *DcimConsoleConnectionsList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDcimConsoleConnectionsList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDcimConsoleConnectionsList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDcimConsoleConnectionsList200Response(val *DcimConsoleConnectionsList200Response) *NullableDcimConsoleConnectionsList200Response {
	return &NullableDcimConsoleConnectionsList200Response{value: val, isSet: true}
}

func (v NullableDcimConsoleConnectionsList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDcimConsoleConnectionsList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
