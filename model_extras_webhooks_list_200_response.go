...
// ExtrasWebhooksList200Response struct for ExtrasWebhooksList200Response
type ExtrasWebhooksList200Response struct {
...
func NewExtrasWebhooksList200Response(count int32, results []Webhook) *ExtrasWebhooksList200Response {
	this := ExtrasWebhooksList200Response{}
	this.Count = count
...
func (o *ExtrasWebhooksList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *ExtrasWebhooksList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o ExtrasWebhooksList200Response) MarshalJSON() ([]byte, error) {
...
type NullableExtrasWebhooksList200Response struct {
	value *ExtrasWebhooksList200Response
	isSet bool
}

func (v NullableExtrasWebhooksList200Response) Get() *ExtrasWebhooksList200Response {
	return v.value
}

func (v *NullableExtrasWebhooksList200Response) Set(val *ExtrasWebhooksList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableExtrasWebhooksList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableExtrasWebhooksList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtrasWebhooksList200Response(val *ExtrasWebhooksList200Response) *NullableExtrasWebhooksList200Response {
	return &NullableExtrasWebhooksList200Response{value: val, isSet: true}
}

func (v NullableExtrasWebhooksList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtrasWebhooksList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
