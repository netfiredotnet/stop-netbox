...
// IpamPrefixesList200Response struct for IpamPrefixesList200Response
type IpamPrefixesList200Response struct {
...
func NewIpamPrefixesList200Response(count int32, results []Prefix) *IpamPrefixesList200Response {
	this := IpamPrefixesList200Response{}
	this.Count = count
...
func (o *IpamPrefixesList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *IpamPrefixesList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o IpamPrefixesList200Response) MarshalJSON() ([]byte, error) {
...
type NullableIpamPrefixesList200Response struct {
	value *IpamPrefixesList200Response
	isSet bool
}

func (v NullableIpamPrefixesList200Response) Get() *IpamPrefixesList200Response {
	return v.value
}

func (v *NullableIpamPrefixesList200Response) Set(val *IpamPrefixesList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamPrefixesList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamPrefixesList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamPrefixesList200Response(val *IpamPrefixesList200Response) *NullableIpamPrefixesList200Response {
	return &NullableIpamPrefixesList200Response{value: val, isSet: true}
}

func (v NullableIpamPrefixesList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamPrefixesList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
