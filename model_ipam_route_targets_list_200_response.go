...
// IpamRouteTargetsList200Response struct for IpamRouteTargetsList200Response
type IpamRouteTargetsList200Response struct {
...
func NewIpamRouteTargetsList200Response(count int32, results []RouteTarget) *IpamRouteTargetsList200Response {
	this := IpamRouteTargetsList200Response{}
	this.Count = count
...
func (o *IpamRouteTargetsList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *IpamRouteTargetsList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o IpamRouteTargetsList200Response) MarshalJSON() ([]byte, error) {
...
type NullableIpamRouteTargetsList200Response struct {
	value *IpamRouteTargetsList200Response
	isSet bool
}

func (v NullableIpamRouteTargetsList200Response) Get() *IpamRouteTargetsList200Response {
	return v.value
}

func (v *NullableIpamRouteTargetsList200Response) Set(val *IpamRouteTargetsList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamRouteTargetsList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamRouteTargetsList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamRouteTargetsList200Response(val *IpamRouteTargetsList200Response) *NullableIpamRouteTargetsList200Response {
	return &NullableIpamRouteTargetsList200Response{value: val, isSet: true}
}

func (v NullableIpamRouteTargetsList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamRouteTargetsList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
