...
// ExtrasCustomFieldsList200Response struct for ExtrasCustomFieldsList200Response
type ExtrasCustomFieldsList200Response struct {
...
func NewExtrasCustomFieldsList200Response(count int32, results []CustomField) *ExtrasCustomFieldsList200Response {
	this := ExtrasCustomFieldsList200Response{}
	this.Count = count
...
func (o *ExtrasCustomFieldsList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *ExtrasCustomFieldsList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o ExtrasCustomFieldsList200Response) MarshalJSON() ([]byte, error) {
...
type NullableExtrasCustomFieldsList200Response struct {
	value *ExtrasCustomFieldsList200Response
	isSet bool
}

func (v NullableExtrasCustomFieldsList200Response) Get() *ExtrasCustomFieldsList200Response {
	return v.value
}

func (v *NullableExtrasCustomFieldsList200Response) Set(val *ExtrasCustomFieldsList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableExtrasCustomFieldsList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableExtrasCustomFieldsList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtrasCustomFieldsList200Response(val *ExtrasCustomFieldsList200Response) *NullableExtrasCustomFieldsList200Response {
	return &NullableExtrasCustomFieldsList200Response{value: val, isSet: true}
}

func (v NullableExtrasCustomFieldsList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtrasCustomFieldsList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
