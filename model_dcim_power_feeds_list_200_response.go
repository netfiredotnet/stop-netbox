...
// DcimPowerFeedsList200Response struct for DcimPowerFeedsList200Response
type DcimPowerFeedsList200Response struct {
...
func NewDcimPowerFeedsList200Response(count int32, results []PowerFeed) *DcimPowerFeedsList200Response {
	this := DcimPowerFeedsList200Response{}
	this.Count = count
...
func (o *DcimPowerFeedsList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *DcimPowerFeedsList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o DcimPowerFeedsList200Response) MarshalJSON() ([]byte, error) {
...
type NullableDcimPowerFeedsList200Response struct {
	value *DcimPowerFeedsList200Response
	isSet bool
}

func (v NullableDcimPowerFeedsList200Response) Get() *DcimPowerFeedsList200Response {
	return v.value
}

func (v *NullableDcimPowerFeedsList200Response) Set(val *DcimPowerFeedsList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDcimPowerFeedsList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDcimPowerFeedsList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDcimPowerFeedsList200Response(val *DcimPowerFeedsList200Response) *NullableDcimPowerFeedsList200Response {
	return &NullableDcimPowerFeedsList200Response{value: val, isSet: true}
}

func (v NullableDcimPowerFeedsList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDcimPowerFeedsList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
